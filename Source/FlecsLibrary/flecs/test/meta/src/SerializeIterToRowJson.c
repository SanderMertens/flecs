...
void SerializeIterToRowJson_serialize_not(void) {
    ...
    char* expect = "{\"results\":[{\"name\":\"e3\", \"components\":{\"Position\":{\"x\":30, \"y\":40}}}]}";
    test_str(json, expect);
...
void SerializeIterToRowJson_serialize_not_pair_var(void) {
    ...
    char* expect = "{\"results\":["
        "{\"name\":\"e3\", \"pairs\":{\"RelA\":\"TgtA\"},\"vars\":{\"var\":\"*\"}}]}";
    test_str(json, expect);
...
void SerializeIterToRowJson_serialize_not_pair_var_constrained(void) {
    ...
    char* expect = "{\"results\":["
        "{\"name\":\"e1\", \"pairs\":{\"RelA\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}, "
        "{\"name\":\"e2\", \"pairs\":{\"RelA\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}]}";
    test_str(json, expect);
...
void SerializeIterToRowJson_serialize_optional_pair_var(void) {
    ...
    char* expect = "{\"results\":["
        "{\"name\":\"e3\", \"pairs\":{\"RelA\":\"TgtA\"},\"vars\":{\"var\":\"*\"}}, "
        "{\"name\":\"e1\", \"pairs\":{\"RelA\":\"TgtA\", \"RelB\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}, "
        "{\"name\":\"e2\", \"pairs\":{\"RelA\":\"TgtA\", \"RelB\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}]}";
    test_str(json, expect);
...
void SerializeIterToRowJson_serialize_optional_pair_var_constrained(void) {
    ...
    char* expect = "{\"results\":["
        "{\"name\":\"e1\", \"pairs\":{\"RelA\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}, "
        "{\"name\":\"e2\", \"pairs\":{\"RelA\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}, "
        "{\"name\":\"e3\", \"pairs\":{\"RelA\":\"TgtA\", \"RelB\":\"TgtA\"},\"vars\":{\"var\":\"TgtA\"}}]}";
    test_str(json, expect);
...
void SerializeIterToRowJson_serialize_scope(void) {
     ...
     *       refactor. */
    char* expect = "{\"results\":["
        "{\"name\":\"e1\", \"tags\":[\"TagA\", \"TagB\"],\"pairs\":{\"ChildOf\":\"e1\"},\"vars\":{\"child\":\"*\"}}, "
        "{\"name\":\"e3\", \"tags\":[\"TagA\", \"TagB\", \"TagB\"],\"pairs\":{\"ChildOf\":\"e2\"},\"vars\":{\"child\":\"*\"}}]}";
    test_str(json, expect);
