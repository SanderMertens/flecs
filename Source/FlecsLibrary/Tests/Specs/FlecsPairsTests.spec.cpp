...
BEGIN_DEFINE_SPEC(FFlecsPairsTestsSpec,
                  "FlecsLibrary.Pairs",
...
void Pairs_add_tag_pair(void) {
    ...
    entity.set_second<Position>(Pair, {10, 20});
...
void Pairs_add_tag_pair_to_tag(void) {
    ...
    test_str(entity.type().str().c_str(), "(Pair,TestTag)");
}
...
void Pairs_remove_tag_pair(void) {
    ...
    entity.remove_second<Position>(Pair);
    test_assert(!(entity.has_second<Position>(Pair)));
}
...
END_DEFINE_SPEC(FFlecsPairsTestsSpec);
...
void FFlecsPairsTestsSpec::Define()
{
	It("Pairs_add_component_pair", [&]() { Pairs_add_component_pair(); });
    It("Pairs_add_tag_pair", [&]() { Pairs_add_tag_pair(); });
    It("Pairs_add_tag_pair_to_tag", [&]() { Pairs_add_tag_pair_to_tag(); });
    It("Pairs_remove_component_pair", [&]() { Pairs_remove_component_pair(); });
    It("Pairs_remove_tag_pair", [&]() { Pairs_remove_tag_pair(); });
    It("Pairs_remove_tag_pair_to_tag", [&]() { Pairs_remove_tag_pair_to_tag(); });
    It("Pairs_set_component_pair", [&]() { Pairs_set_component_pair(); });
    It("Pairs_set_tag_pair", [&]() { Pairs_set_tag_pair(); });
    It("Pairs_system_1_pair_instance", [&]() { Pairs_system_1_pair_instance(); });
    It("Pairs_system_2_pair_instances", [&]() { Pairs_system_2_pair_instances(); });
    It("Pairs_override_pair", [&]() { Pairs_override_pair(); });
    It("Pairs_override_tag_pair", [&]() { Pairs_override_tag_pair(); });
    It("Pairs_ensure_pair", [&]() { Pairs_ensure_pair(); });
    It("Pairs_ensure_pair_existing", [&]() { Pairs_ensure_pair_existing(); });
    It("Pairs_ensure_pair_tag", [&]() { Pairs_ensure_pair_tag(); });
    It("Pairs_ensure_pair_tag_existing", [&]() { Pairs_ensure_pair_tag_existing(); });
    It("Pairs_ensure_R_tag_O", [&]() { Pairs_ensure_R_tag_O(); });
    It("Pairs_get_relation_from_id", [&]() { Pairs_get_relation_from_id(); });
    It("Pairs_get_second_from_id", [&]() { Pairs_get_second_from_id(); });
    It("Pairs_get_recycled_relation_from_id", [&]() { Pairs_get_recycled_relation_from_id(); });
    It("Pairs_get_recycled_object_from_id", [&]() { Pairs_get_recycled_object_from_id(); });
    It("Pairs_get_rel_obj", [&]() { Pairs_get_rel_obj(); });
    It("Pairs_get_rel_obj_id", [&]() { Pairs_get_rel_obj_id(); });
    It("Pairs_get_rel_obj_id_t", [&]() { Pairs_get_rel_obj_id_t(); });
    It("Pairs_get_R_obj", [&]() { Pairs_get_R_obj(); });
    It("Pairs_get_R_obj_id", [&]() { Pairs_get_R_obj_id(); });
    It("Pairs_get_R_obj_id_t", [&]() { Pairs_get_R_obj_id_t(); });
    It("Pairs_get_R_O", [&]() { Pairs_get_R_O(); });
    It("Pairs_get_R_tag_O", [&]() { Pairs_get_R_tag_O(); });
    It("Pairs_get_second", [&]() { Pairs_get_second(); });
    It("Pairs_get_second_id", [&]() { Pairs_get_second_id(); });
    It("Pairs_get_second_id_t", [&]() { Pairs_get_second_id_t(); });
    It("Pairs_each", [&]() { Pairs_each(); });
    It("Pairs_each_pair", [&]() { Pairs_each_pair(); });
    It("Pairs_each_pair_by_type", [&]() { Pairs_each_pair_by_type(); });
    It("Pairs_each_pair_w_isa", [&]() { Pairs_each_pair_w_isa(); });
    It("Pairs_each_pair_w_recycled_rel", [&]() { Pairs_each_pair_w_recycled_rel(); });
    It("Pairs_each_pair_w_recycled_obj", [&]() { Pairs_each_pair_w_recycled_obj(); });
    It("Pairs_match_pair", [&]() { Pairs_match_pair(); });
    It("Pairs_match_pair_obj_wildcard", [&]() { Pairs_match_pair_obj_wildcard(); });
    It("Pairs_match_pair_rel_wildcard", [&]() { Pairs_match_pair_rel_wildcard(); });
    It("Pairs_match_pair_both_wildcard", [&]() { Pairs_match_pair_both_wildcard(); });
    It("Pairs_has_tag_w_object", [&]() { Pairs_has_tag_w_object(); });
    It("Pairs_has_second_tag", [&]() { Pairs_has_second_tag(); });
    It("Pairs_add_pair_type", [&]() { Pairs_add_pair_type(); });
    It("Pairs_remove_pair_type", [&]() { Pairs_remove_pair_type(); });
    It("Pairs_set_pair_type", [&]() { Pairs_set_pair_type(); });
    It("Pairs_has_pair_type", [&]() { Pairs_has_pair_type(); });
    It("Pairs_get_1_pair_arg", [&]() { Pairs_get_1_pair_arg(); });
    It("Pairs_get_2_pair_arg", [&]() { Pairs_get_2_pair_arg(); });
    It("Pairs_set_1_pair_arg", [&]() { Pairs_set_1_pair_arg(); });
    It("Pairs_set_2_pair_arg", [&]() { Pairs_set_2_pair_arg(); });
    It("Pairs_get_inline_pair_type", [&]() { Pairs_get_inline_pair_type(); });
    It("Pairs_set_inline_pair_type", [&]() { Pairs_set_inline_pair_type(); });
    It("Pairs_get_pair_type_object", [&]() { Pairs_get_pair_type_object(); });
    It("Pairs_set_pair_type_object", [&]() { Pairs_set_pair_type_object(); });
    It("Pairs_set_get_second_variants", [&]() { Pairs_set_get_second_variants(); });
    It("Pairs_get_object_for_type_self", [&]() { Pairs_get_object_for_type_self(); });
    It("Pairs_get_object_for_type_base", [&]() { Pairs_get_object_for_type_base(); });
    It("Pairs_get_object_for_id_self", [&]() { Pairs_get_object_for_id_self(); });
    It("Pairs_get_object_for_id_base", [&]() { Pairs_get_object_for_id_base(); });
    It("Pairs_get_object_for_id_not_found", [&]() { Pairs_get_object_for_id_not_found(); });
    It("Pairs_deref_pair", [&]() { Pairs_deref_pair(); });
    It("Pairs_deref_const_pair", [&]() { Pairs_deref_const_pair(); });
    It("Pairs_deref_pair_obj", [&]() { Pairs_deref_pair_obj(); });
    It("Pairs_deref_const_pair_obj", [&]() { Pairs_deref_const_pair_obj(); });
    It("Pairs_set_R_existing_value", [&]() { Pairs_set_R_existing_value(); });
    It("Pairs_symmetric_w_childof", [&]() { Pairs_symmetric_w_childof(); });
    It("Pairs_modified_tag_second", [&]() { Pairs_modified_tag_second(); });
    It("Pairs_modified_tag_first", [&]() { Pairs_modified_tag_first(); });
