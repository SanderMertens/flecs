...
INLINE static CONSTEXPR int32_t ECS_INVALID_OPERATION = 1;
INLINE static CONSTEXPR int32_t ECS_INVALID_PARAMETER = 2;
INLINE static CONSTEXPR int32_t ECS_CONSTRAINT_VIOLATED = 3;
INLINE static CONSTEXPR int32_t ECS_OUT_OF_MEMORY = 4;
INLINE static CONSTEXPR int32_t ECS_OUT_OF_RANGE = 5;
INLINE static CONSTEXPR int32_t ECS_UNSUPPORTED = 6;
INLINE static CONSTEXPR int32_t ECS_INTERNAL_ERROR = 7;
INLINE static CONSTEXPR int32_t ECS_ALREADY_DEFINED = 8;
INLINE static CONSTEXPR int32_t ECS_MISSING_OS_API = 9;
INLINE static CONSTEXPR int32_t ECS_OPERATION_FAILED = 10;
INLINE static CONSTEXPR int32_t ECS_INVALID_CONVERSION = 11;
INLINE static CONSTEXPR int32_t ECS_ID_IN_USE = 12;
INLINE static CONSTEXPR int32_t ECS_CYCLE_DETECTED = 13;
INLINE static CONSTEXPR int32_t ECS_LEAK_DETECTED = 14;
INLINE static CONSTEXPR int32_t ECS_DOUBLE_FREE = 15;

INLINE static CONSTEXPR int32_t ECS_INCONSISTENT_NAME = 20;
INLINE static CONSTEXPR int32_t ECS_NAME_IN_USE = 21;
INLINE static CONSTEXPR int32_t ECS_NOT_A_COMPONENT = 22;
INLINE static CONSTEXPR int32_t ECS_INVALID_COMPONENT_SIZE = 23;
INLINE static CONSTEXPR int32_t ECS_INVALID_COMPONENT_ALIGNMENT = 24;
INLINE static CONSTEXPR int32_t ECS_COMPONENT_NOT_REGISTERED = 25;
INLINE static CONSTEXPR int32_t ECS_INCONSISTENT_COMPONENT_ID = 26;
INLINE static CONSTEXPR int32_t ECS_INCONSISTENT_COMPONENT_ACTION = 27;
INLINE static CONSTEXPR int32_t ECS_MODULE_UNDEFINED = 28;
INLINE static CONSTEXPR int32_t ECS_MISSING_SYMBOL = 29;
INLINE static CONSTEXPR int32_t ECS_ALREADY_IN_USE = 30;

INLINE static CONSTEXPR int32_t ECS_ACCESS_VIOLATION = 40;
INLINE static CONSTEXPR int32_t ECS_COLUMN_INDEX_OUT_OF_RANGE = 41;
INLINE static CONSTEXPR int32_t ECS_COLUMN_IS_NOT_SHARED = 42;
INLINE static CONSTEXPR int32_t ECS_COLUMN_IS_SHARED = 43;
INLINE static CONSTEXPR int32_t ECS_COLUMN_TYPE_MISMATCH = 45;

INLINE static CONSTEXPR int32_t ECS_INVALID_WHILE_READONLY = 70;
INLINE static CONSTEXPR int32_t ECS_LOCKED_STORAGE = 71;
INLINE static CONSTEXPR int32_t ECS_INVALID_FROM_WORKER = 72;
