...
void FilterBuilder_query_as_arg(void) {
    flecs::world ecs;
...
void FilterBuilder_query_as_move_arg(void) {
    flecs::world ecs;
...
void FilterBuilder_query_as_return(void) {
    flecs::world ecs;
...
void FilterBuilder_query_copy(void) {
    flecs::world ecs;
...
void FilterBuilder_world_each_query_1_component(void) {
    flecs::world ecs;
...
void FilterBuilder_world_each_query_2_components(void) {
    flecs::world ecs;
...
void FilterBuilder_world_each_query_1_component_no_entity(void) {
    flecs::world ecs;
...
void FilterBuilder_world_each_query_2_components_no_entity(void) {
    flecs::world ecs;
