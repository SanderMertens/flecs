...
static ecs_entity_t register_prefab(ecs_world_t *world) {
    ECS_TAG(world, Foo);

    ecs_entity_t turret = ecs_entity(world, { .name = "Turret" });
    ecs_add_id(world, turret, EcsPrefab);
    ecs_add(world, turret, Foo);

    ecs_entity(world, { .name = "Head", .parent = turret });
    ecs_entity(world, { .name = "Base", .parent = turret });
    return turret;
}
...
void DeserializeFromJson_ser_deser_prefab_instance_w_named_children(void) {
...

    {
        ecs_world_t *world = ecs_init();
        ECS_TAG(world, Bar);
        ecs_entity_t turret = register_prefab(world);

        ecs_entity_t instance = ecs_entity(world, { .name = "instance" });
        ecs_add_pair(world, instance, EcsIsA, turret);
        ecs_add_id(world, instance, Bar);
...

    {
        ecs_world_t *world = ecs_init();
        ECS_TAG(world, Bar);
        register_prefab(world);

        ecs_world_from_json(world, json, NULL);

        ecs_entity_t instance = ecs_lookup(world, "instance");
        test_assert(ecs_lookup_child(world, instance, "Head") != 0);
        test_assert(ecs_lookup_child(world, instance, "Base") != 0);
        test_assert(ecs_has_id(world, instance, ecs_lookup(world, "Foo")));
        test_assert(ecs_has_id(world, instance, Bar));
...
static ecs_entity_t register_parent_prefab(ecs_world_t *world) {
    ECS_TAG(world, Foo);
    ...
    ecs_new_w_parent(world, turret, "Head");
    ecs_new_w_parent(world, turret, "Base");
...
void DeserializeFromJson_ser_deser_prefab_instance_w_named_children_parent_component(void) {
...

    {
        ecs_world_t *world = ecs_init();
        ECS_TAG(world, Bar);
        ecs_entity_t turret = register_parent_prefab(world);
...
void DeserializeFromJson_ser_deser_dont_fragment_pair_w_component(void) {
...

    {
        ...
        ecs_entity_t component = ecs_component(world, {
            .entity = ecs_entity(world, { .name = "ComponentStruct" }),
            .type.size = sizeof(ComponentStruct),
            .type.alignment = ECS_ALIGNOF(ComponentStruct)
        });
        ecs_struct(world, {
            .entity = component,
            .members = {
        ...
        ecs_entity_t relationship = ecs_entity(world, {
            .name = "RelationshipStruct"
        });
        ecs_add_id(world, relationship, EcsRelationship);
        ecs_add_id(world, relationship, EcsDontFragment);

        ecs_entity_t entity = ecs_entity(world, { .name = "Entity" });
        ecs_entity_t session = ecs_entity(world, { .name = "Session" });

        ecs_add_pair(world, entity, relationship, session);

        ComponentStruct value = { .value = true };
        ecs_set_id(world, entity, component, sizeof(ComponentStruct), &value);
...

    {
        ...
        ecs_entity_t entity = ecs_lookup(world, "Entity");
        ecs_entity_t session = ecs_lookup(world, "Session");
        test_assert(entity != 0);
        test_assert(session != 0);
        test_assert(ecs_has_id(world, entity, component));
        test_assert(ecs_has_pair(world, entity, relationship, session));
...
void DeserializeFromJson_ser_deser_dont_fragment_component(void) {
    typedef struct { int32_t x, y; } Position;
...

    {
        ...
        ecs_add_id(world, pos, EcsDontFragment);

        ecs_entity_t e = ecs_entity(world, { .name = "e" });
        Position p = { 10, 20 };
        ecs_set_id(world, e, pos, sizeof(Position), &p);
...
void DeserializeFromJson_ser_deser_dont_fragment_pair_multi_target(void) {
...

    {
        ...
        ecs_entity_t TgtA = ecs_entity(world, { .name = "TgtA" });
        ecs_entity_t TgtB = ecs_entity(world, { .name = "TgtB" });
...

    {
        ...
        ecs_entity_t e = ecs_lookup(world, "e");
        ecs_entity_t TgtA = ecs_lookup(world, "TgtA");
        ecs_entity_t TgtB = ecs_lookup(world, "TgtB");
        test_assert(e != 0);
        test_assert(TgtA != 0);
        test_assert(TgtB != 0);
        test_assert(ecs_has_pair(world, e, Rel, TgtA));
...
void DeserializeFromJson_ser_deser_dont_fragment_component_pair(void) {
...

    {
        ...
        ecs_entity_t e = ecs_entity(world, { .name = "e" });
        Position p = { 10, 20 };
        ecs_set_id(world, e, ecs_pair(pos, TgtA), sizeof(Position), &p);
...

    {
        ...
        test_assert(e != 0);
        test_assert(TgtA != 0);
        test_assert(ecs_has_pair(world, e, pos, TgtA));

        const Position *p = ecs_get_id(world, e, ecs_pair(pos, TgtA));
        test_assert(p != NULL);
        test_int(p->x, 10);
        test_int(p->y, 20);
...
void DeserializeFromJson_ser_deser_dont_fragment_tag_removes_stale(void) {
...

    {
        ...
        ecs_add_id(world, TagA, EcsDontFragment);

        ecs_entity_t TagB = ecs_entity(world, { .name = "TagB" });
        ecs_add_id(world, TagB, EcsDontFragment);
...
void DeserializeFromJson_map_empty(void) {
    ...
    const char *ptr = ecs_ptr_from_json(world, t, &value, "{}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');
...
void DeserializeFromJson_map_into_populated(void) {
    ...
    ptr = ecs_ptr_from_json(world, t, &value, "{\"30\": 300}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');
...
void DeserializeFromJson_map_u64_i32(void) {
    ...
    const char *ptr = ecs_ptr_from_json(world, t, &value, 
        "{\"18446744073709551615\": 10}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');

    test_int(ecs_map_count(&value), 1);
    ecs_map_val_t *v = ecs_map_get(&value, UINT64_MAX);
    test_assert(v != NULL);
    test_int(*(int32_t*)v, 10);
...
void DeserializeFromJson_map_i32_i32_negative_key(void) {
    ...
    test_int(ecs_map_count(&value), 2);
    ecs_map_val_t *v = ecs_map_get(&value, (uint32_t)-10);
    test_assert(v != NULL);
...
void DeserializeFromJson_map_enum_i32(void) {
    ...
    const char *ptr = ecs_ptr_from_json(world, t, &value, 
        "{\"Red\": 10, \"Green\": 20, \"Blue\": 30}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');

    test_int(ecs_map_count(&value), 3);
...
void DeserializeFromJson_map_bitmask_i32(void) {
    ...
    const char *ptr = ecs_ptr_from_json(world, t, &value, 
        "{\"Lettuce|Bacon\": 10, \"Tomato\": 20, \"0\": 30}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');
...
void DeserializeFromJson_map_bitmask_i32_multi_flag_key(void) {
    ...
    const char *ptr = ecs_ptr_from_json(world, t, &value,
        "{\"Lettuce|Bacon\": 10, \"Tomato\": 20}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');
...
void DeserializeFromJson_map_id_pair_i32(void) {
    ...
    test_int(ecs_map_count(&value), 1);
    ecs_map_val_t *v = ecs_map_get(&value, ecs_pair(rel, tgt));
    test_assert(v != NULL);
    test_int(*(int32_t*)v, 10);
...
void DeserializeFromJson_map_i64_enum_underlying_i16(void) {
    ...
    ecs_map_val_t *v = ecs_map_get(&value, 10);
    test_assert(v != NULL);
    test_int(*(int16_t*)v, 0);
    v = ecs_map_get(&value, 20);
    test_assert(v != NULL);
    test_int(*(int16_t*)v, 1);
    v = ecs_map_get(&value, 30);
    test_assert(v != NULL);
    test_int(*(int16_t*)v, 2);
...
void DeserializeFromJson_value_bool(void) {
    ...
    ecs_value_t v = {0};
    const char *ptr = ecs_ptr_from_json(world, ecs_id(ecs_value_t), &v,
        "{\"bool\": true}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');
...
void DeserializeFromJson_value_bitmask(void) {
    ...
    ecs_value_t v = {0};
    const char *ptr = ecs_ptr_from_json(world, ecs_id(ecs_value_t), &v,
        "{\"T\": \"Bacon|Lettuce\"}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');

    test_uint(v.type, t);
    test_assert(v.ptr != NULL);
    test_uint(*(uint32_t*)v.ptr, 3);
...
void DeserializeFromJson_value_map(void) {
    ...
    ecs_map_val_t *value = ecs_map_get(map, 10);
    test_assert(value != NULL);
    test_int(*(int32_t*)value, 100);
...
void DeserializeFromJson_value_assign_same_type(void) {
    ...
    test_int(*(int32_t*)v.ptr, 10);
    void *value_ptr = v.ptr;

    ptr = ecs_ptr_from_json(world, ecs_id(ecs_value_t), &v,
        "{\"i32\": 20}", NULL);
    test_assert(ptr != NULL);
    test_uint(v.type, ecs_id(ecs_i32_t));
    test_assert(v.ptr == value_ptr);
    test_int(*(int32_t*)v.ptr, 20);
...
void DeserializeFromJson_struct_w_value(void) {
    ...
    S value = {{0}};
    const char *ptr = ecs_ptr_from_json(world, ecs_id(S), &value,
        "{\"v\": {\"i32\": 10}}", NULL);
    test_assert(ptr != NULL);
    test_assert(ptr[0] == '\0');

    test_uint(value.v.type, ecs_id(ecs_i32_t));
    test_assert(value.v.ptr != NULL);
    test_int(*(int32_t*)value.v.ptr, 10);
