...
void DeserializeFromJson_struct_w_vec_i32_and_vec_vec_i32(void);
...
bake_test_case DeserializeFromJson_testcases[] = {
    ...
    {
        "struct_w_vec_i32_and_vec_vec_i32",
        DeserializeFromJson_struct_w_vec_i32_and_vec_vec_i32
    },
    {
...
bake_test_case SerializeEntityToJson_testcases[] = {
    ...
    },
    {
        ...
        SerializeEntityToJson_serialize_w_meta_ids
    },
    {
        "serialize_color",
