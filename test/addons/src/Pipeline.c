...
void Pipeline_system_order_after_new_system_lower_id(void) {
    ...
    ecs_entity(world, { .id = Sys, .name = "SysA" });
    ecs_add_pair(world, Sys, EcsDependsOn, EcsOnUpdate);
...
void Pipeline_system_order_after_new_system_inbetween_id(void) {
    ...
    /* Create new system with Sys id */
    ecs_entity(world, { .id = Sys, .name = "SysB" });
    ecs_add_pair(world, Sys, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = Sys,
        .query.expr = "Position",
...
void Pipeline_system_order_after_new_system_higher_id(void) {
    ...
    /* Create new system with Sys id */
    ecs_entity(world, { .id = Sys, .name = "SysC" });
    ecs_add_pair(world, Sys, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = Sys,
        .query.expr = "Position",
...
void Pipeline_3_systems_3_types(void) {
    ...
    ecs_entity_t s1 = ecs_entity(world, { .name = "SysA" });
    ecs_add_pair(world, s1, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s1,
        .query.expr = "Position",
        .callback = SysA
    });
    ecs_entity_t s2 = ecs_entity(world, { .name = NULL });
    ecs_add_pair(world, s2, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s2,
        .query.expr = "Position",
        .callback = SysB
    });
    ecs_entity_t s3 = ecs_entity(world, { .name = "SysC" });
    ecs_add_pair(world, s3, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s3,
        .query.expr = "Position()",
        .callback = SysC
...
void Pipeline_system_reverse_order_by_phase_custom_pipeline(void) {
    ...
    ecs_entity_t s1 = ecs_new(world);
    ecs_add_id(world, s1, Tag);
    ecs_add_pair(world, s1, EcsDependsOn, PostFrame);
    ecs_system_init(world, &(ecs_system_desc_t){
        .callback = cb_third,
        .ctx = &count,
        .entity = s1
    ...
    ecs_entity_t s2 = ecs_new(world);
    ecs_add_id(world, s2, Tag);
    ecs_add_pair(world, s2, EcsDependsOn, OnFrame);
    ecs_system_init(world, &(ecs_system_desc_t){
        .callback = cb_second,
        .ctx = &count,
        .entity = s2
    ...
    ecs_entity_t s3 = ecs_new(world);
    ecs_add_id(world, s3, Tag);
    ecs_add_pair(world, s3, EcsDependsOn, PreFrame);
    ecs_system_init(world, &(ecs_system_desc_t){
        .callback = cb_first,
        .ctx = &count,
        .entity = s3
...
void Pipeline_stage_write_before_read(void) {
    ...
    ecs_entity_t s2 = ecs_entity(world, { .name = "SysB" });
    ecs_add_id(world, s2, Tag);
    ecs_add_pair(world, s2, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s2,
...
static void Pipeline_mixed_multithreaded_internal(bool task_threads) {
    ...
    ecs_entity_t s4 = ecs_entity(world, { .name = "SysD" });
    ecs_add_id(world, s4, Tag);
    ecs_add_pair(world, s4, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s4,
        .query.expr = "Position",
        .callback = SysD,
    ...
    ecs_entity_t s5 = ecs_entity(world, { .name = "SysE" });
    ecs_add_id(world, s5, Tag);
    ecs_add_pair(world, s5, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s5,
        .query.expr = "Position",
        .callback = SysE,
    ...
    ecs_entity_t s6 = ecs_entity(world, { .name = "SysF" });
    ecs_add_id(world, s6, Tag);
    ecs_add_pair(world, s6, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s6,
        .query.expr = "Position",
        .callback = SysF
...
void Pipeline_single_threaded_pipeline_change(void) {
    ...
    ecs_entity_t s3 = ecs_entity(world, { .name = "WritePosition" });
    ecs_add_pair(world, s3, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s3,
    ...
    ecs_entity_t s4 = ecs_entity(world, { .name = "SysC" });
    ecs_add_pair(world, s4, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s4,
        .query.expr = "Tag, Position",
    ...
    ecs_entity_t s5 = ecs_entity(world, { .name = "SysD" });
    ecs_add_pair(world, s5, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s5,
        .query.expr = "Tag, !Position",
...
void Pipeline_activate_after_add(void) {
    ...
    ecs_entity_t s1 = ecs_entity(world, { .name = "WritePosition" });
    ecs_add_pair(world, s1, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s1,
        .query.expr = "Tag, [out] Position()",
    ...
    ecs_entity_t s2 = ecs_entity(world, { .name = "SysA" });
    ecs_add_pair(world, s2, EcsDependsOn, EcsOnUpdate);
    ecs_system_init(world, &(ecs_system_desc_t){
        .entity = s2,
        .query.expr = "Position",
...
void Pipeline_no_staging_system_create_query(void) {
    ...
    ecs_entity_t s = ecs_entity(world, { .name = "CreateQuery" });
    ecs_add_id(world, s, Tag);
...
void Pipeline_disable_parent(void) {
    ...
    ecs_system(world, {
        .entity = ecs_entity(world, { .parent = p1 }),
        .phase = EcsOnUpdate,
        .callback = SysA
    });

    ecs_system(world, {
        .entity = ecs_entity(world, { .parent = p2 }),
        .phase = EcsPostUpdate,
        .callback = SysB
    });
...
void Pipeline_disable_component_from_immediate_system(void) {
    ...
    ToggleTag = ecs_entity(world, { .id = ToggleTag, .name = "ToggleTag" });
    ecs_id(ToggleTag) = ToggleTag;
    ecs_add_id(world, ToggleTag, EcsCanToggle);
...
void Pipeline_empty_pipeline_after_disable_phase(void) {
    ...
    ecs_entity_t s1 = ecs_new(world);
    ecs_add_pair(world, s1, EcsDependsOn, CustomPhase);
    ecs_system(world, {
        .entity = s1,
        .callback = SysA
    });
...
static void VarSrcSystem(ecs_iter_t *it) {
    var_src_ctx_t *ctx = it->ctx;
    int32_t i;
    for (i = 0; i < it->count; i ++) {
        ctx->invoked ++;
        ctx->entity = it->entities[i];
        ctx->target = ecs_iter_get_var(it, 1);
    }
}
...
void Pipeline_write_wildcard_w_var_src_term(void) {
    ...
    ecs_entity_t rel = ecs_new_w_id(world, EcsRelationship);
    ecs_entity_t tag_opt = ecs_new(world);

    var_src_ctx_t ctx = {0};

    ecs_entity_t s = ecs_new(world);
    ecs_add_pair(world, s, EcsDependsOn, EcsOnUpdate);
    ecs_entity_t r = ecs_system(world, {
        .entity = s,
        .query.terms = {
            { .first.id = rel, .second = { .name = "Target", .id = EcsIsVariable } },
            { .id = EcsWildcard, .inout = EcsOut, .src.id = EcsIsEntity },
            { .id = tag_opt, .src = { .name = "Target", .id = EcsIsVariable } }
        },
        .callback = VarSrcSystem,
        .ctx = &ctx
    });
    test_assert(r == s);

    ecs_entity_t t1 = ecs_new_w_id(world, tag_opt);
    ecs_entity_t t2 = ecs_new(world);
    ecs_entity_t e1 = ecs_new_w_pair(world, rel, t1);
    ecs_entity_t e2 = ecs_new_w_pair(world, rel, t2);
    (void)e2;

    ecs_progress(world, 0);

    test_int(ctx.invoked, 1);
    test_uint(ctx.entity, e1);
    test_uint(ctx.target, t1);

    ecs_add_id(world, t2, tag_opt);
