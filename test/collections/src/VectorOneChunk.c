...
void test_VectorOneChunk_tc_count(
    test_VectorOneChunk this)
{
...
void test_VectorOneChunk_tc_count_empty(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
...
void test_VectorOneChunk_tc_free_empty(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    ecs_vector_free(vec);
...
void test_VectorOneChunk_tc_get(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_get_empty(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
...
void test_VectorOneChunk_tc_get_first(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_get_last(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_get_out_of_bound(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_iter(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_iter_empty(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    EcsIter it = ecs_vector_iter(vec, &vec_params);
...
void test_VectorOneChunk_tc_remove(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_remove_all(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_remove_empty(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
...
void test_VectorOneChunk_tc_remove_first(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_remove_last(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_remove_out_of_bound(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
...
void test_VectorOneChunk_tc_sort_empty(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
...
void test_VectorOneChunk_tc_sort_rnd(
    test_VectorOneChunk this)
{
...
void test_VectorOneChunk_tc_sort_sorted(
    test_VectorOneChunk this)
{
    EcsVector *vec = ecs_vector_new(&vec_params);
    fill_vector(vec);
