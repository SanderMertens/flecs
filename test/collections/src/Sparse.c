...
void Sparse_add_1() {
    ...
    int *ptr = flecs_sparse_get(sp, int, 0);
...
void Sparse_remove() {
    ...
    test_assert(flecs_sparse_get(sp, int, 0) == flecs_sparse_get_sparse(sp, int, i0));
    test_assert(flecs_sparse_get(sp, int, 1) == flecs_sparse_get_sparse(sp, int, i1));
...
void Sparse_remove_first() {
    ...
    test_assert(flecs_sparse_get(sp, int, 0) == flecs_sparse_get_sparse(sp, int, i1));
    test_assert(flecs_sparse_get(sp, int, 1) == flecs_sparse_get_sparse(sp, int, i0));
...
void Sparse_remove_all() {
    ...
    void *elem2 = flecs_sparse_get(sp, int, 1);
    void *elem3 = flecs_sparse_get(sp, int, 2);

    flecs_sparse_remove(sp, 0);
    test_int(flecs_sparse_count(sp), 2);
    test_assert(flecs_sparse_get_sparse(sp, int, 0) == NULL);
    test_assert(flecs_sparse_get_sparse(sp, int, 1) == elem2);
    test_assert(flecs_sparse_get_sparse(sp, int, 2) == elem3);

    flecs_sparse_remove(sp, 1);
    test_int(flecs_sparse_count(sp), 1);
    test_assert(flecs_sparse_get_sparse(sp, int, 0) == NULL);
    test_assert(flecs_sparse_get_sparse(sp, int, 1) == NULL);
    test_assert(flecs_sparse_get_sparse(sp, int, 2) == elem3);    
    ...
    test_assert(flecs_sparse_get_sparse(sp, int, 0) == NULL);
    test_assert(flecs_sparse_get_sparse(sp, int, 1) == NULL);
    test_assert(flecs_sparse_get_sparse(sp, int, 2) == NULL);    
...
void Sparse_copy() {
    ...
    int i;
    for (i = 0; i < 128; i ++) {
        test_int(*flecs_sparse_get_sparse(sp2, int, i), i);
    }
...
void Sparse_restore() {
    ...
    int i;
    for (i = 0; i < 128; i ++) {
        test_int(*flecs_sparse_get_sparse(sp, int, i), i);
    }
...
void Sparse_add_after_clear() {
    ...
    *elem = 10;
    ...
    int *ptr = flecs_sparse_get_sparse(sp, int, indices[0]);
    test_assert(ptr != NULL);
