...
void Remove_w_filter_remove_1_no_filter() {
    ...
    ecs_remove_w_filter(world, Mass, NULL);
...
void Remove_w_filter_remove_2_no_filter() {
    ecs_world_t *world = ecs_init();
    ...
    /* Remove component Mass */
    ecs_remove_w_filter(world, ToRemove, NULL);
...
void Remove_w_filter_remove_1_to_empty_no_filter() {
    ecs_world_t *world = ecs_init();
...
void Remove_w_filter_remove_2_to_empty_no_filter() {
    ecs_world_t *world = ecs_init();
...
void Remove_w_filter_remove_1_all_no_filter() {
    ecs_world_t *world = ecs_init();
    ...
    /* Remove component Mass */
    ecs_remove_w_filter(world, Type_2, NULL);
...
void Remove_w_filter_remove_2_all_no_filter() {
    ecs_world_t *world = ecs_init();
...
void Remove_w_filter_remove_1_exclude_1() {
    ecs_world_t *world = ecs_init();
    ...
    /* Remove component Mass */
    ecs_remove_w_filter(world, Mass, &(ecs_type_filter_t){
...
void Remove_w_filter_remove_1_exclude_2() {
    ecs_world_t *world = ecs_init();
...
void Remove_w_filter_remove_1_include_1() {
    ecs_world_t *world = ecs_init();
...
void Remove_w_filter_remove_1_include_2() {
    ecs_world_t *world = ecs_init();
