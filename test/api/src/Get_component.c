...
void Get_component_get_empty() {
    ...
    test_assert(ecs_get_component(world, e, 0) == 0);
...
void Get_component_get_1_from_1() {
    ...
    test_assert(ecs_get_component(world, e, 0) == ecs_to_entity(Position));
...
void Get_component_get_2_from_2() {
    ...
    test_assert(ecs_get_component(world, e, 1) == ecs_to_entity(Velocity));
...
void Test_main_stage(ecs_rows_t *rows) {
    ...
    for (int i = 0; i < rows->count; i ++) {
        ...
        test_assert(ecs_get_component(rows->world, e, 0) == ecs_to_entity(Position));
    }
}
...
void Add_in_progress(ecs_rows_t *rows) {
    ...
    for (int i = 0; i < rows->count; i ++) {
        ...
        test_assert(ecs_get_component(rows->world, e, 1) == ecs_to_entity(Velocity));
    }
}
...
void Add_remove_in_progress_test_main(ecs_rows_t *rows) {
    ...
    for (int i = 0; i < rows->count; i ++) {
        ...
        test_assert(ecs_get_component(rows->world, e, 0) == ecs_to_entity(Velocity));
        test_assert(ecs_get_component(rows->world, e, 1) == 0);
    }
}
