...
void ComponentLifecycle_ctor_on_tag() {
    ...
    ecs_set(world, Tag, EcsComponentHooks, {
        .ctor = comp_ctor
    });
...
void ComponentLifecycle_merge_to_different_table() {
    ...
    ecs_set(world, ecs_id(Velocity), EcsComponentHooks, {
    ...
    ecs_set(world, ecs_id(Mass), EcsComponentHooks, {
        .ctor = ecs_ctor(Mass),
        .dtor = ecs_dtor(Mass),
        .copy = ecs_copy(Mass),
        .move = ecs_move(Mass)
    ...
    ecs_set(world, ecs_id(Rotation), EcsComponentHooks, {
...
void ComponentLifecycle_ctor_on_add_pair() {
    ...
    ecs_set(world, ecs_id(Pair), EcsComponentHooks, {
        .ctor = comp_ctor,
        .ctx = &ctx
    });
...
void ComponentLifecycle_valid_entity_in_dtor_after_delete() {
    ...
    ecs_set(world, ecs_id(Dummy), EcsComponentHooks, {
        .dtor = dummy_dtor
    });
...
void ComponentLifecycle_valid_other_type_of_entity_in_dtor_on_fini() {
    ...
    ecs_set(world, ecs_id(Entity), EcsComponentHooks, {
...
void ComponentLifecycle_valid_same_type_comp_of_entity_in_dtor_on_fini() {
    ...
    ecs_set(world, ecs_id(String), EcsComponentHooks, {
        .dtor = string_dtor
    });
