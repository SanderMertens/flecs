...
void Id_case_is_wildcard() {
    ecs_world_t *world = ecs_mini();
    ecs_entity_t r = ecs_new_id(world);
    ecs_entity_t o = ecs_new_id(world);
    test_assert( !ecs_id_is_wildcard(ecs_case(r, o)) );
    ecs_fini(world);
}

void Id_case_w_rel_wildcard_is_wildcard() {
    ecs_world_t *world = ecs_mini();
    ecs_entity_t o = ecs_new_id(world);
    test_assert( ecs_id_is_wildcard(ecs_case(EcsWildcard, o)) );
    ecs_fini(world);
}

void Id_case_w_obj_wildcard_is_wildcard() {
    ecs_world_t *world = ecs_mini();
    ecs_entity_t r = ecs_new_id(world);
    test_assert( ecs_id_is_wildcard(ecs_case(r, EcsWildcard)) );
    ecs_fini(world);
}

void Id_case_w_wildcard_wildcard_is_wildcard() {
    test_assert( ecs_id_is_wildcard(ecs_case(EcsWildcard, EcsWildcard)) );
}

void Id_case_w_rel_any_is_wildcard() {
    ecs_world_t *world = ecs_mini();
    ecs_entity_t o = ecs_new_id(world);
    test_assert( ecs_id_is_wildcard(ecs_case(EcsAny, o)) );
    ecs_fini(world);
}

void Id_case_w_obj_any_is_wildcard() {
    ecs_world_t *world = ecs_mini();
    ecs_entity_t r = ecs_new_id(world);
    test_assert( ecs_id_is_wildcard(ecs_case(r, EcsAny)) );
    ecs_fini(world);
}

void Id_case_w_any_any_is_wildcard() {
    test_assert( ecs_id_is_wildcard(ecs_case(EcsAny, EcsAny)) );
}
