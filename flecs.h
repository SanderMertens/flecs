...
private:
    template < template<typename Func, typename ... Comps> typename Invoker, typename Func, typename ... Args>
    void iterate(Func&& func, ecs_iter_next_action_t next, Args &&... args) const {
        ecs_iter_t it = ecs_query_iter(m_query);
