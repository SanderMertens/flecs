    ...
    ecs_table_t *table)
{
    ...
    int32_t column_count = ecs_vector_count(system_data->base.columns);
    ...
    int32_t c, count = ecs_vector_count(system_data->base.columns);
    ...
    void *param)
{
    ...
    int32_t i, table_count = ecs_vector_count(system_data->tables);
