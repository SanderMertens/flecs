...
static bool flecs_meta_rtt_init_default_hooks_struct(ecs_world_t *world, ecs_entity_t component,
...
static bool flecs_meta_rtt_init_default_hooks_array(ecs_world_t *world, ecs_entity_t component,
                                                    const ecs_type_info_t *ti) {
