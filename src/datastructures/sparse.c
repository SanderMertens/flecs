    ...
    int32_t page_index)
{
    ...
    /* If page_index is below zero, application used an invalid entity id */
    ecs_assert(page_index >= 0, ECS_INVALID_PARAMETER, NULL);
    ecs_page_t *result = ecs_vec_get_t(&sparse->pages, ecs_page_t, page_index);
