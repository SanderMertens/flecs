...
void posix_set_os_api(void) {
    ...
    api.thread_new = posix_thread_new;
    api.thread_join = posix_thread_join;
    api.ainc = posix_ainc;
    api.adec = posix_adec;
    api.mutex_new = posix_mutex_new;
    api.mutex_free = posix_mutex_free;
    api.mutex_lock = posix_mutex_lock;
    api.mutex_unlock = posix_mutex_unlock;
    api.cond_new = posix_cond_new;
    api.cond_free = posix_cond_free;
    api.cond_signal = posix_cond_signal;
    api.cond_broadcast = posix_cond_broadcast;
    api.cond_wait = posix_cond_wait;
